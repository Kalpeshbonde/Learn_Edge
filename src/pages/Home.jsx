...
const Home = () => {
    return (
        <div>
            ...
            <div className='relative mx-auto flex flex-col w-11/12 max-w-screen-xl items-center text-white'>
                ...
                <div className='text-center text-4xl font-semibold mt-4 items-center'>
                    Empower Your Future with
                    <HighLightText text={" Coding Skills"} />
                </div>

                <div className='mx-1 my-6 w-[90%] sm:w-[60%] rounded-xl'>
  ...
  <Link to={"/signup"}>
    <div className='group p-1 rounded-full bg-richblue-800 font-bold text-richblack-200 transition-all duration-200 hover:scale-95 w-fit shadow-[0px_2px_2px_white]'>
      <div className='flex items-center gap-2 rounded-full px-4 py-[5px] transition-all duration-200 group-hover:bg-richblack-900'>
  ...
  {/* Learn More and Book a Demo Buttons */}
